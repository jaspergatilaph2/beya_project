        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">List's/</span>Pets</h4>
                    <!-- Flash message -->
                    @if(session('success'))
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-info btn-sm mb-1" data-bs-toggle="modal" data-bs-target="#viewPetModal{{ $appointment->id }}">
                                                    View
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="viewPetModal{{ $appointment->id }}" tabindex="-1" aria-labelledby="viewPetModalLabel{{ $appointment->id }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="viewPetModalLabel{{ $appointment->id }}">Pet Details</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="row mb-3">
                                                                    <div class="col-md-4 text-center">
                                                                        <img src="{{ $appointment->pets_picture ? asset('storage/' . $appointment->pets_picture) : asset('storage/pets/default.png') }}"
                                                                            alt="Pet Image"
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <ul class="list-group list-group-flush">
                                                                            <li class="list-group-item"><strong>Owner's Name:</strong> {{ $appointment->owner_name }}</li>
                                                                            <li class="list-group-item"><strong>Pet's Name:</strong> {{ $appointment->pet_name }}</li>
                                                                            <li class="list-group-item"><strong>Breed:</strong> {{ $appointment->pet_breed }}</li>

                                                                            @if($appointment->upload_document)
                                                                            <li class="list-group-item">
                                                                                <strong>Document:</strong><br>
                                                                                <a href="{{ asset('storage/' . $appointment->upload_document) }}" target="_blank">
                                                ...
                                                <form action="{{ route('admin.pets.destroy', $appointment->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
