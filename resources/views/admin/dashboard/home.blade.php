          ...
          <div class="container">
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; height:13rem;">
                      <strong style="font-size:8.5rem; text-align:center;">
                        {{ \App\Models\Appointments::distinct('owner_name')->count('owner_name') }}
                      </strong>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 pt-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; height:13rem;">
                      <strong style="font-size:8.5rem; text-align:center;">{{ \App\Models\Appointments::where('status', 'pending')->count() }}</strong>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 pt-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; height:13rem;">
                      <strong style="font-size:8.5rem; text-align:center;">{{ \App\Models\Appointments::where('status', 'confirmed')->select('owner_name')->distinct()->count('owner_name') }}</strong>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 pt-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; height:13rem;">
                      <strong style="font-size:8.5rem; text-align:center;">{{ \App\Models\Appointments::where('status', 'cancelled')->select('owner_name')->distinct()->count('owner_name') }}</strong>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-3 mb-4">
                      <div class="d-flex flex-column flex-sm-column flex-row align-items-start justify-content-between flex-grow-1">
                        <div class="card-title">
                          <h5 class="text-nowrap mb-2">APPOINTMENTS REPORT</h5>
                          <span class="badge bg-label-warning rounded-pill">Year</span>
                        </div>
                        <div class="mt-sm-auto">
                          <strong style="font-size:15px;" class="text-primary">
                            <i class="bx bx-chevron-up"></i>
                            {{ \App\Models\Appointments::distinct('owner_name')->count('owner_name') }} Appointments
                          </strong>
                        </div>
                      </div>
                      <div id="profileReportChart" class="flex-shrink-0"></div>
                    </div>

                    <!-- Chart Container -->
                    <div id="chartContainer" class="w-100" style="min-height: 100px;">
                      <canvas id="myChart" style="width:100%;height:100%;min-height:170px;max-height:300px;"></canvas>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 pt-3">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">OWNERS TOTAL ADDED NUMBERS</h5>
                    <p class="card-text">Here the <span class="fw-bold" style="color: #ff6347;">total</span> owners added.</p>
                    <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
                    <div style="display: flex; justify-content: center; align-items: center;">
                      <strong style="font-size:8.4rem; text-align:center;">{{ \App\Models\Appointments::distinct('owner_name')->count('owner_name') }}</strong>
                    </div>
                  </div>
                </div>
              </div>
